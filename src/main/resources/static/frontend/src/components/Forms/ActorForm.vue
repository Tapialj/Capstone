<template>
  ...
  <form class="form" @submit.prevent="checkForm" novalidate>
      ...
      <div class="form-control">
        ...
        <input type="text" id="firstName" name="firstName" v-model="actor.firstName" />
      </div>

      <div class="form-control">
        <label for="lastName">Last Name</label>
        <input type="text" id="lastName" name="lastName" v-model="actor.lastName" />
      </div>
      ...
      <div class="form-control flex">
        ...
        <div class="grid check-container">
          <div :key="movie.id" class="checkbox" v-for="movie in movies">
            <input :key="movie.id" type="checkbox" name="movie" :id="[movie.lastName, movie.firstName]" :value="movie.id" v-model="selectedMovies" /><!--:checked="directedBy(movie.actor.id)"-->
  ...
  export default {
    ...
    methods: {
      checkForm() {
        ...
        if(!this.actor.firstName || this.actor.firstName === "") {
          this.errors.push("First Name is Required")
        }
        
        if(!this.actor.lastName || this.actor.lastName === "") {
      ...
      submitActor() {
        ...
        this.$emit("save-actor", { actor: this.actor, movies: this.selectedMovieObjects, moviesRemoved: this.removedMovieObjects });
      },
      selectMovies() {
    ...
    async created() {
      ...
      if(this.edit.edit) {
        this.actor = await this.getActorDetails(this.edit.id);
